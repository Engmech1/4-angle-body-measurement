...
High-precision computer vision, biomechanical, ML, and research-backed anthropometric package.
"""
...
from body_measurement.research_integrations import (
    FullBodyBiometricReport,
    ResearchAnthropometricEngine,
    SMPLShapeEstimate,
)
